...
interface ActivePoolCalls {
  ...
  getSAIDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getSEI(_overrides?: CallOverrides): Promise<BigNumber>;
...
interface ActivePoolTransactions {
  decreaseSAIDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseSAIDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  sendSEI(_account: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
...
export interface ActivePool
  ...
  readonly filters: {
    ...
    ActivePoolSAIDebtUpdated(_SAIDebt?: null): EventFilter;
    ActivePoolSEIBalanceUpdated(_SEI?: null): EventFilter;
    ...
    SAIBalanceUpdated(_newBalance?: null): EventFilter;
    SEIBalanceUpdated(_newBalance?: null): EventFilter;
    SeiSent(_to?: null, _amount?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "ActivePoolSAIDebtUpdated"): _TypedLogDescription<{ _SAIDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "ActivePoolSEIBalanceUpdated"): _TypedLogDescription<{ _SEI: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "SAIBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "SEIBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "SeiSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
...
interface BorrowerOperationsCalls {
  ...
  SAI_GAS_COMPENSATION(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  floStaking(_overrides?: CallOverrides): Promise<string>;
  floStakingAddress(_overrides?: CallOverrides): Promise<string>;
  ...
  saiToken(_overrides?: CallOverrides): Promise<string>;
...
interface BorrowerOperationsTransactions {
  ...
  adjustTrove(_maxFeePercentage: BigNumberish, _collWithdrawal: BigNumberish, _SAIChange: BigNumberish, _isDebtIncrease: boolean, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  claimCollateral(_overrides?: Overrides): Promise<void>;
  closeTrove(_overrides?: Overrides): Promise<void>;
  moveSEIGainToTrove(_borrower: string, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  openTrove(_maxFeePercentage: BigNumberish, _SAIAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  repaySAI(_SAIAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_troveManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _sortedTrovesAddress: string, _saiTokenAddress: string, _floStakingAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawColl(_collWithdrawal: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  withdrawSAI(_maxFeePercentage: BigNumberish, _SAIAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
}
...
export interface BorrowerOperations
  ...
  readonly filters: {
    ...
    FLOStakingAddressChanged(_floStakingAddress?: null): EventFilter;
    GasPoolAddressChanged(_gasPoolAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    SAIBorrowingFeePaid(_borrower?: string | null, _SAIFee?: null): EventFilter;
    SAITokenAddressChanged(_saiTokenAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "FLOStakingAddressChanged"): _TypedLogDescription<{ _floStakingAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "SAIBorrowingFeePaid"): _TypedLogDescription<{ _borrower: string; _SAIFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "SAITokenAddressChanged"): _TypedLogDescription<{ _saiTokenAddress: string }>[];
...
interface CommunityIssuanceCalls {
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  FLOSupplyCap(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  floToken(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  stabilityPoolAddress(_overrides?: CallOverrides): Promise<string>;
  totalFLOIssued(_overrides?: CallOverrides): Promise<BigNumber>;
}

interface CommunityIssuanceTransactions {
  issueFLO(_overrides?: Overrides): Promise<BigNumber>;
  sendFLO(_account: string, _FLOamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_floTokenAddress: string, _stabilityPoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface CommunityIssuance
  extends _TypedLiquityContract<CommunityIssuanceCalls, CommunityIssuanceTransactions> {
  readonly filters: {
    FLOTokenAddressSet(_floTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StabilityPoolAddressSet(_stabilityPoolAddress?: null): EventFilter;
    TotalFLOIssuedUpdated(_totalFLOIssued?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "FLOTokenAddressSet"): _TypedLogDescription<{ _floTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressSet"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "TotalFLOIssuedUpdated"): _TypedLogDescription<{ _totalFLOIssued: BigNumber }>[];
}
...
interface DefaultPoolTransactions {
  decreaseSAIDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseSAIDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  sendSEIToActivePool(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
...
export interface DefaultPool
  ...
  readonly filters: {
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    DefaultPoolAddressChanged(_newDefaultPoolAddress?: null): EventFilter;
    DefaultPoolSAIDebtUpdated(_SAIDebt?: null): EventFilter;
    DefaultPoolSEIBalanceUpdated(_SEI?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    SAIBalanceUpdated(_newBalance?: null): EventFilter;
    SEIBalanceUpdated(_newBalance?: null): EventFilter;
    SeiSent(_to?: null, _amount?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _newActivePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _newDefaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "DefaultPoolSAIDebtUpdated"): _TypedLogDescription<{ _SAIDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "DefaultPoolSEIBalanceUpdated"): _TypedLogDescription<{ _SEI: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "SAIBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "SEIBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "SeiSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
...
interface HintHelpersCalls {
  ...
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionHints(_SAIamount: BigNumberish, _price: BigNumberish, _maxIterations: BigNumberish, _overrides?: CallOverrides): Promise<{ firstRedemptionHint: string; partialRedemptionHintNICR: BigNumber; truncatedSAIamount: BigNumber }>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface LockupContractFactoryCalls {
  ...
  floTokenAddress(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
...
interface LockupContractFactoryTransactions {
  ...
  setFLOTokenAddress(_floTokenAddress: string, _overrides?: Overrides): Promise<void>;
}
...
interface SAITokenTransactions {
  approve(spender: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
...
export interface SAIToken
  extends _TypedLiquityContract<SAITokenCalls, SAITokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    SAITokenBalanceUpdated(_user?: null, _amount?: null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
    Transfer(from?: string | null, to?: string | null, value?: null): EventFilter;
    TroveManagerAddressChanged(_troveManagerAddress?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "Approval"): _TypedLogDescription<{ owner: string; spender: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  extractEvents(logs: Log[], name: "SAITokenBalanceUpdated"): _TypedLogDescription<{ _user: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{ _troveManagerAddress: string }>[];
}

interface FLOStakingCalls {
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  F_SAI(_overrides?: CallOverrides): Promise<BigNumber>;
  F_SEI(_overrides?: CallOverrides): Promise<BigNumber>;
  NAME(_overrides?: CallOverrides): Promise<string>;
  activePoolAddress(_overrides?: CallOverrides): Promise<string>;
  borrowerOperationsAddress(_overrides?: CallOverrides): Promise<string>;
  floToken(_overrides?: CallOverrides): Promise<string>;
  getPendingSAIGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingSEIGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  saiToken(_overrides?: CallOverrides): Promise<string>;
  snapshots(arg0: string, _overrides?: CallOverrides): Promise<{ F_SEI_Snapshot: BigNumber; F_SAI_Snapshot: BigNumber }>;
  stakes(arg0: string, _overrides?: CallOverrides): Promise<BigNumber>;
  totalFLOStaked(_overrides?: CallOverrides): Promise<BigNumber>;
  troveManagerAddress(_overrides?: CallOverrides): Promise<string>;
}

interface FLOStakingTransactions {
  increaseF_SAI(_SAIFee: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseF_SEI(_SEIFee: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_floTokenAddress: string, _saiTokenAddress: string, _troveManagerAddress: string, _borrowerOperationsAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
  stake(_FLOamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  unstake(_FLOamount: BigNumberish, _overrides?: Overrides): Promise<void>;
}

export interface FLOStaking
  extends _TypedLiquityContract<FLOStakingCalls, FLOStakingTransactions> {
  readonly filters: {
    ...
    FLOTokenAddressSet(_floTokenAddress?: null): EventFilter;
    F_SAIUpdated(_F_SAI?: null): EventFilter;
    F_SEIUpdated(_F_SEI?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    SAITokenAddressSet(_saiTokenAddress?: null): EventFilter;
    SeiSent(_account?: null, _amount?: null): EventFilter;
    StakeChanged(staker?: string | null, newStake?: null): EventFilter;
    StakerSnapshotsUpdated(_staker?: null, _F_SEI?: null, _F_SAI?: null): EventFilter;
    StakingGainsWithdrawn(staker?: string | null, SAIGain?: null, SEIGain?: null): EventFilter;
    TotalFLOStakedUpdated(_totalFLOStaked?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "FLOTokenAddressSet"): _TypedLogDescription<{ _floTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "F_SAIUpdated"): _TypedLogDescription<{ _F_SAI: BigNumber }>[];
  extractEvents(logs: Log[], name: "F_SEIUpdated"): _TypedLogDescription<{ _F_SEI: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "SAITokenAddressSet"): _TypedLogDescription<{ _saiTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "SeiSent"): _TypedLogDescription<{ _account: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakeChanged"): _TypedLogDescription<{ staker: string; newStake: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakerSnapshotsUpdated"): _TypedLogDescription<{ _staker: string; _F_SEI: BigNumber; _F_SAI: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakingGainsWithdrawn"): _TypedLogDescription<{ staker: string; SAIGain: BigNumber; SEIGain: BigNumber }>[];
  extractEvents(logs: Log[], name: "TotalFLOStakedUpdated"): _TypedLogDescription<{ _totalFLOStaked: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressSet"): _TypedLogDescription<{ _troveManager: string }>[];
}

interface FLOTokenCalls {
...
interface FLOTokenTransactions {
  approve(spender: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  decreaseAllowance(spender: string, subtractedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  increaseAllowance(spender: string, addedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  permit(owner: string, spender: string, amount: BigNumberish, deadline: BigNumberish, v: BigNumberish, r: BytesLike, s: BytesLike, _overrides?: Overrides): Promise<void>;
  sendToFLOStaking(_sender: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  transfer(recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  transferFrom(sender: string, recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
}

export interface FLOToken
  extends _TypedLiquityContract<FLOTokenCalls, FLOTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    CommunityIssuanceAddressSet(_communityIssuanceAddress?: null): EventFilter;
    FLOStakingAddressSet(_floStakingAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "FLOStakingAddressSet"): _TypedLogDescription<{ _floStakingAddress: string }>[];
...
interface MultiTroveGetterCalls {
  getMultipleSortedTroves(_startIdx: BigNumberish, _count: BigNumberish, _overrides?: CallOverrides): Promise<{ owner: string; debt: BigNumber; coll: BigNumber; stake: BigNumber; snapshotSEI: BigNumber; snapshotSAIDebt: BigNumber }[]>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
  troveManager(_overrides?: CallOverrides): Promise<string>;
}
...
interface PriceFeedCalls {
  ...
  NAME(_overrides?: CallOverrides): Promise<string>;
  SEIUSD_TELLOR_REQ_ID(_overrides?: CallOverrides): Promise<BigNumber>;
...
interface StabilityPoolCalls {
  ...
  getCompoundedSAIDeposit(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorFLOGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorSEIGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getFrontEndFLOGain(_frontEnd: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getSEI(_overrides?: CallOverrides): Promise<BigNumber>;
  getTotalSAIDeposits(_overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  lastFLOError(_overrides?: CallOverrides): Promise<BigNumber>;
  lastSAILossError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  lastSEIError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  saiToken(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _troveManagerAddress: string, _activePoolAddress: string, _saiTokenAddress: string, _sortedTrovesAddress: string, _priceFeedAddress: string, _communityIssuanceAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawFromSP(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  withdrawSEIGainToTrove(_upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
}
...
export interface StabilityPool
  ...
  readonly filters: {
    ...
    FLOPaidToDepositor(_depositor?: string | null, _FLO?: null): EventFilter;
    FLOPaidToFrontEnd(_frontEnd?: string | null, _FLO?: null): EventFilter;
    ...
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    SAITokenAddressChanged(_newSAITokenAddress?: null): EventFilter;
    SEIGainWithdrawn(_depositor?: string | null, _SEI?: null, _SAILoss?: null): EventFilter;
    ...
    StabilityPoolSAIBalanceUpdated(_newBalance?: null): EventFilter;
    StabilityPoolSEIBalanceUpdated(_newBalance?: null): EventFilter;
    TroveManagerAddressChanged(_newTroveManagerAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "FLOPaidToDepositor"): _TypedLogDescription<{ _depositor: string; _FLO: BigNumber }>[];
  extractEvents(logs: Log[], name: "FLOPaidToFrontEnd"): _TypedLogDescription<{ _frontEnd: string; _FLO: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "SAITokenAddressChanged"): _TypedLogDescription<{ _newSAITokenAddress: string }>[];
  extractEvents(logs: Log[], name: "SEIGainWithdrawn"): _TypedLogDescription<{ _depositor: string; _SEI: BigNumber; _SAILoss: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "StabilityPoolSAIBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "StabilityPoolSEIBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{ _newTroveManagerAddress: string }>[];
...
interface TroveManagerCalls {
  ...
  CCR(_overrides?: CallOverrides): Promise<BigNumber>;
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  L_SAIDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  L_SEI(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  floStaking(_overrides?: CallOverrides): Promise<string>;
  floToken(_overrides?: CallOverrides): Promise<string>;
  getBorrowingFee(_SAIDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  getBorrowingFeeWithDecay(_SAIDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getEntireDebtAndColl(_borrower: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; pendingSAIDebtReward: BigNumber; pendingSEIReward: BigNumber }>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getNominalICR(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingSAIDebtReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingSEIReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionFeeWithDecay(_SEIDrawn: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  lastSAIDebtError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  lastSEIError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  rewardSnapshots(arg0: string, _overrides?: CallOverrides): Promise<{ SEI: BigNumber; SAIDebt: BigNumber }>;
  saiToken(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface TroveManagerTransactions {
  ...
  redeemCollateral(_SAIamount: BigNumberish, _firstRedemptionHint: string, _upperPartialRedemptionHint: string, _lowerPartialRedemptionHint: string, _partialRedemptionHintNICR: BigNumberish, _maxIterations: BigNumberish, _maxFeePercentage: BigNumberish, _overrides?: Overrides): Promise<void>;
  removeStake(_borrower: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _saiTokenAddress: string, _sortedTrovesAddress: string, _floTokenAddress: string, _floStakingAddress: string, _overrides?: Overrides): Promise<void>;
...
export interface TroveManager
  ...
  readonly filters: {
    ...
    DefaultPoolAddressChanged(_defaultPoolAddress?: null): EventFilter;
    FLOStakingAddressChanged(_floStakingAddress?: null): EventFilter;
    FLOTokenAddressChanged(_floTokenAddress?: null): EventFilter;
    GasPoolAddressChanged(_gasPoolAddress?: null): EventFilter;
    LTermsUpdated(_L_SEI?: null, _L_SAIDebt?: null): EventFilter;
    LastFeeOpTimeUpdated(_lastFeeOpTime?: null): EventFilter;
    Liquidation(_liquidatedDebt?: null, _liquidatedColl?: null, _collGasCompensation?: null, _SAIGasCompensation?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    Redemption(_attemptedSAIAmount?: null, _actualSAIAmount?: null, _SEISent?: null, _SEIFee?: null): EventFilter;
    SAITokenAddressChanged(_newSAITokenAddress?: null): EventFilter;
    SortedTrovesAddressChanged(_sortedTrovesAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_stabilityPoolAddress?: null): EventFilter;
    ...
    TroveSnapshotsUpdated(_L_SEI?: null, _L_SAIDebt?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _defaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "FLOStakingAddressChanged"): _TypedLogDescription<{ _floStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "FLOTokenAddressChanged"): _TypedLogDescription<{ _floTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "GasPoolAddressChanged"): _TypedLogDescription<{ _gasPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "LTermsUpdated"): _TypedLogDescription<{ _L_SEI: BigNumber; _L_SAIDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "LastFeeOpTimeUpdated"): _TypedLogDescription<{ _lastFeeOpTime: BigNumber }>[];
  extractEvents(logs: Log[], name: "Liquidation"): _TypedLogDescription<{ _liquidatedDebt: BigNumber; _liquidatedColl: BigNumber; _collGasCompensation: BigNumber; _SAIGasCompensation: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "Redemption"): _TypedLogDescription<{ _attemptedSAIAmount: BigNumber; _actualSAIAmount: BigNumber; _SEISent: BigNumber; _SEIFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "SAITokenAddressChanged"): _TypedLogDescription<{ _newSAITokenAddress: string }>[];
  extractEvents(logs: Log[], name: "SortedTrovesAddressChanged"): _TypedLogDescription<{ _sortedTrovesAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "TroveSnapshotsUpdated"): _TypedLogDescription<{ _L_SEI: BigNumber; _L_SAIDebt: BigNumber }>[];
...
interface UnipoolTransactions {
  ...
  setParams(_floTokenAddress: string, _uniTokenAddress: string, _duration: BigNumberish, _overrides?: Overrides): Promise<void>;
