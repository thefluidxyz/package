...
```
npm install --save @fluid/lib-base @fluid/lib-ethers ethers@^5.0.0
```
...
const { EthersLiquity } = require("@fluid/lib-ethers");
...
Liquity's [Dev UI](https://github.com/liquity/liquity/tree/master/packages/dev-frontend) itself contains many examples of `@fluid/lib-ethers` use.
