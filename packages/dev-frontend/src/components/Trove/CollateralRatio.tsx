...
import { CRITICAL_COLLATERAL_RATIO, Decimal, Difference, Percent } from "@fluid/lib-base";
            ...
            <InfoIcon
              tooltip={
                <Card variant="tooltip" sx={{ width: "220px" }}>
                  The ratio between the dollar value of the collateral and the debt (in SAI) you are
