...
export const selectForTroveChangeValidation = ({
  ...
  lusdBalance,
  numberOfTroves
}: FluidStoreState) => ({ price, total, accountBalance, lusdBalance, numberOfTroves });
...
export const validateTroveChange = (
  ...
  console.log (errorDescription, "TTTTTTTTTTTTTTTTTT")
...
const validateTroveCreation = (
  ...
  console.log (recoveryMode, wouldTriggerRecoveryMode, ccrPercent, "IIIIIIIIIIIIIIII")
