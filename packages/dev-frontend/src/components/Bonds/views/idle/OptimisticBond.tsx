  ...
  return [
    {
      ...
      label: (
        <>
          <Label description="bSAI accrual starts off at 0 and increases over time.">
            {l.BOND_CREATED.term}
          </Label>
          <SubLabel>{`0.00 bSAI`}</SubLabel>
        </>
      )
    },
    {
    ...
    },
    {
      ...
      label: (
        <>
          <Label description="How many bSAI are required to break-even at the current market price.">
    ...
    },
    {
      ...
      label: (
        <>
          <Label description="How many bSAI are recommended before claiming the bond, selling the bSAI for SAI, and then opening another bond.">
      ...
      <Card mt={[0, 0, 0, 0]} sx={{ borderRadius: 12, flexGrow: 1 }}>
        <Flex p={[2, 3]} sx={{ flexDirection: "column" }}>
          ...
          <Flex mt={4} variant="layout.actions" sx={{ justifyContent: "flex-end" }}>
            ...
            >
              <Record lexicon={l.BOND_DEPOSIT} value={bond.deposit.prettify(2)} type="SAI" />

              <Record lexicon={l.MARKET_VALUE} type="SAI" />
            </Flex>
