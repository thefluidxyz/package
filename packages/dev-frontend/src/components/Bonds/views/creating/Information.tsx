...
export const Information: React.FC = () => {
  ...
  return (
    <InformationContainer>
      <Box sx={{ p: [2, 3] }}>
        <Paragraph sx={{ mt: 2 }}>
          Bonds accrue a virtual balance of boosted SAI tokens (bSAI) over time. At any time, the
          bonder may choose to claim their bSAI in exchange for their SAI, or cancel their bond to
          recover their deposited SAI.
        </Paragraph>
        <Paragraph sx={{ mt: 3 }}>
          Please visit the&nbsp;
