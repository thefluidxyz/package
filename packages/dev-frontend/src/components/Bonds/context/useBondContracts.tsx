...
import { CurveCryptoSwap2ETH__factory } from "@fluid/chicken-bonds/lusd/types/external";
import {
  BLUSDToken__factory,
  BondNFT__factory,
...
import LUSDTokenAbi from "@fluid/lib-ethers/abi/LUSDToken.json";
...
import type { CurveLiquidityGaugeV5 } from "@fluid/chicken-bonds/lusd/types/external/CurveLiquidityGaugeV5";
...
export const useBondContracts = (): BondContracts => {
  ...
  const [lusdTokenDefault, lusdTokenDefaultStatus] = useContract<LUSDToken>(
    fluid.connection.addresses.lusdToken,
    LUSDTokenAbi
  );
