...
import { SentFluidTransaction, FluidReceipt } from "@fluid/lib-base";
...
type SentTransaction = SentFluidTransaction<
  TransactionResponse,
  FluidReceipt<TransactionReceipt>
>;
