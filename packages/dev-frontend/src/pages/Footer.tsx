export const Footer: React.FC = () => {
    return (
        <div className="fixed bottom-0 w-full flex flex-col sm:flex-row items-start sm:items-center justify-between bg-[#E1B1FF] px-5 sm:px-9 md:px-[56px] lg:px-[76px] mt-[42px]">
