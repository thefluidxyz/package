...
const FrontendRegistrationAction: React.FC<FrontendRegistrationActionProps> = ({ kickbackRate }) => {
  ...
  return myTransactionState.type === "waitingForApproval" ? (
    ...
    <Transaction id={myTransactionId} send={fluid.registerFrontend.bind(fluid, kickbackRate)}>
    ...
    <>
      ...
      >
        ...
        <Paragraph sx={{ fontSize: 1, mt: 3 }}>
          ...
          <b>{cut.mul(100).toString()}%</b> of the FLO rewards earned through this frontend.
        </Paragraph>
