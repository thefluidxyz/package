...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawSAI(...params) {
    return this.forwardFunction(params, 'withdrawSAI(uint256,uint256,address,address)')
  }

  async repaySAI(...params) {
    return this.forwardFunction(params, 'repaySAI(uint256,address,address)')
  }
  ...
  async SAI_GAS_COMPENSATION(...params) {
    return this.proxyFunction('SAI_GAS_COMPENSATION', params)
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingSAIDebtReward(...params) {
    return this.proxyFunction('getPendingSAIDebtReward', params)
  }
  ...
  async L_SAIDebt() {
    return this.proxyFunction('L_SAIDebt', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedSAIDeposit(user) {
    return this.proxyFunctionWithUser('getCompoundedSAIDeposit', user)
  }
...
class FLOStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token)
  }
  ...
  async F_SAI(user) {
    return this.proxyFunctionWithUser('F_SAI', user)
  }
}
