...
const ABDKOperations = async () => {
    ...
    // Example computaton: SAI -> Ether price conversion

    // price = 200.12345678, stored as uint
    // convert 6123456700909.123456789123456789 SAI to Ether
    // amount = 6123456700909.123456789123456789 SAI / 200.12345678 
    ...
    */
    ...
    /* TODO: will L_ETH, L_SAI overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
