...
contract('TroveManager', async accounts => {
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    SAIDebt left in Default Pool is: 108
    ...
    SAIDebt left in Default Pool is: 653
  */
  ...
  /* ABDK64, no error correction:
    ...
    SAIDebt left in Default Pool is: 75 
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    SAIDebt left in Default Pool is: 180 
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    let totalSAIDebtPoolDifference = web3.utils.toBN(0)

    for (account of accounts.slice(1, 11)) {
      const activePoolETH = await activePool.getETH()
      const activePoolSAIDebt = await activePool.getSAI()
      ...
      totalSAIDebtPoolDifference.add(activePoolSAIDebt.sub(defaultPoolSAIDebt))
    }
    
    console.log(`Accumulated ETH difference between Default and Active Pools is: ${totalETHPoolDifference}`)
    console.log(`Accumulated SAIDebt difference between Active and Default Pools is: ${totalSAIDebtPoolDifference}`)
  })
  
  /* ABDK64, no error correction
    Accumulated ETH difference between Default and Active Pools is: 0
    Accumulated SAIDebt difference between Active and Default Pools is: 0
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalSAIRewards = (totalColl.mul(L_SAIDebt)).div(_1e18_BN)

    const defaultPoolETH = await defaultPool.getETH()
    const defaultPoolSAIDebt = await defaultPool.getSAIDebt()

    const ETHRewardDifference = defaultPoolETH.sub(totalETHRewards)
    const SAIDebtRewardDifference = defaultPoolSAIDebt.sub(totalSAIRewards)

    console.log(`ETH difference between total pending rewards and DefaultPool: ${ETHRewardDifference} `)
    console.log(`SAIDebt difference between total pending rewards and DefaultPool: ${SAIDebtRewardDifference} `)
  })

  /* ABDK64, no error correction:
    ETH difference between total pending rewards and DefaultPool: 700
    SAIDebt difference between total pending rewards and DefaultPool: 800

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    SAIDebt difference between total pending rewards and DefaultPool: 400
    
    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: -100
    SAIDebt difference between total pending rewards and DefaultPool: -200

    Pure division with correction: 
    ETH difference between total pending rewards and DefaultPool: 0
    SAIDebt difference between total pending rewards and DefaultPool: 0
  */
  ...
  /* ABDK64, no error correction:
    ...
    SAIDebt difference between total pending rewards and DefaultPool: 55000
    
    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31000
    SAIDebt difference between total pending rewards and DefaultPool: 31000

    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: 2000
    SAIDebt difference between total pending rewards and DefaultPool: -2000
 ...
 it("11 accounts with random ETH and proportional SAI (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })

  await th.openTrove_allAccounts_randomETH_ProportionalSAI(1, 2, accounts.slice(0, 11), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    SAIDebt difference between total pending rewards and DefaultPool: 8000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    SAIDebt difference between total pending rewards and DefaultPool: 300
    ...
    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 100
    SAIDebt difference between total pending rewards and DefaultPool: 100
  */

  it("101 accounts with random ETH and proportional SAI (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(1000, 'ether') })

    await th.openTrove_allAccounts_randomETH_ProportionalSAI(1, 2, accounts.slice(0, 101), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    SAIDebt difference between total pending rewards and DefaultPool: 61000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31300
    SAIDebt difference between total pending rewards and DefaultPool: 30000
    ...
    SAIDebt difference between total pending rewards and DefaultPool: 1000
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
   // Acct 99 opens trove with 100 SAI
    await borrowerOperations.openTrove(0, 0,  accounts[99], { from: accounts[99], value: dec(100, 'ether') })
    await borrowerOperations.withdrawSAI(0, dec(100, 18), accounts[99], {from: accounts[99]})
    ...
    // On loop: Account[99] adds 10 SAI to pool -> a trove gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    const totalSAIRewards_Distribution = (totalColl.mul(L_SAIDebt)).div(_1e18_BN)

    const defaultPoolETH = await defaultPool.getETH()
    const defaultPoolSAIDebt = await defaultPool.getSAIDebt()

    const ETHRewardDifference = defaultPoolETH.sub(totalETHRewards_Distribution)
    const SAIDebtRewardDifference = defaultPoolSAIDebt.sub(totalSAIRewards_Distribution)

    console.log(`ETH difference between total pending distribution rewards and DefaultPool: ${ETHRewardDifference} `)
    console.log(`SAIDebt difference between total pending distribution rewards and DefaultPool: ${SAIDebtRewardDifference} `)
  })

  /* ABDK64, no error correction
    ETH difference between total pending distribution rewards and DefaultPool: 550
    SAIDebt difference between total pending distribution rewards and DefaultPool: 600
    
    DeciMath, no error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 150
    SAIDebt difference between total pending distribution rewards and DefaultPool: -200
    
    Pure division with error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 50
    SAIDebt difference between total pending distribution rewards and DefaultPool: 0
  */

  it("101 accounts. 100 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 SAI
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawSAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
  ...
  /* ABDK64, no error correction
    ...
    SAIDebt difference between total pending distribution rewards and DefaultPool: 8900
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last SAI withdrawal from SP to underflow and fail. 
    ...
    const SP_SAI = await stabilityPool.getTotalSAIDeposits()  

    const SP_SAI_Insufficiency = web3.utils.toBN(whaleSPDeposit).sub(SP_SAI)

     // check Stability Pool
    console.log(`Surplus ETH left in in Stability Pool is ${SP_ETH}`)
    console.log(`SAI insufficiency in Stability Pool is ${SP_SAI_Insufficiency}`)
   })

   /* ABDK64, no error correction
      Sometimes subtraction overflows on last withdrawal from SP - error leaves insufficient SAI in Pool.
      ...
      SAI insufficiency in Stability Pool is 530
      
      DeciMath, no error correction:
      Surplus ETH left in in Stability Pool is 0
      SAI insufficiency in Stability Pool is 0
   ...
   /* ABDK64, no error correction
    ...
    SAI insufficiency in Stability Pool is 5300
   ...
   */
   ...
   it("11 accounts. 10 Borrowers add to SP, random SAI amounts. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 SAI
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawSAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
   ...
   /* ABDK64, no error correction
      ...
      SAI insufficiency in Stability Pool is 442
      ...
      SAI insufficiency in Stability Pool is 67

      Pure division with error correction:
      Surplus ETH left in in Stability Pool is 446
      SAI insufficiency in Stability Pool is 507
    */

   it("101 accounts. 100 Borrowers add to SP, random SAI amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 SAI
     await borrowerOperations.openTrove(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })
     await borrowerOperations.withdrawSAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
   ...
   /* ABDK64, no error correction
    ...
    SAI insufficiency in Stability Pool is 1112

    DeciMath, no error correction:
    Surplus ETH left in in Stability Pool is 1373
    SAI insufficiency in Stability Pool is -13

    Pure division with no error correction:
    Surplus ETH left in in Stability Pool is 4087
    SAI insufficiency in Stability Pool is 1960

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 3072
    SAI insufficiency in Stability Pool is 452
  */ 

 it("501 accounts. 500 Borrowers add to SP, random SAI amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
  // Acct 99 opens trove with 100 SAI
   await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
   await borrowerOperations.withdrawSAI(0, dec(100, 18), accounts[999], {from: accounts[999]})
  ...
  /* ABDK64, no error correction:
    ...
    SAI insufficiency in Stability Pool is -8445

    Pure division, no correction:
    Surplus ETH left in in Stability Pool is 18708
    SAI insufficiency in Stability Pool is 25427

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 1573
    SAI insufficiency in Stability Pool is 6037
  */ 
...
/* DeciMath:
  ...
  SAIDebt left in Default Pool is: 308731912

  Pure division, correction:
  ETH left in Default Pool is: 1136050360
  SAIDebt left in Default Pool is: 997601870

  Pure division, no correction:
  ETH left in Default Pool is: 810899932
  SAIDebt left in Default Pool is: 535042995
*/
...
it("101 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 500 accounts do a Trove operation (apply rewards)", async () => {
 ...
 /*
  ...
  SAIDebt left in Default Pool is: 14696382412

  Pure division, correction:
  ETH left in Default Pool is: 9281255535
  SAIDebt left in Default Pool is: 5854012464
  */
...
it("11 accounts with random ETH and proportional SAI (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  ...
  // Troves open with 100-200 million ether and proportional SAI Debt
  await th.openTrove_allAccounts_randomETH_ProportionalSAI(100000000, 200000000, accounts.slice(0, 11), contracts, 180)
...
/* 
  ...
  SAIDebt difference between total pending rewards and DefaultPool: 12000000000

  Pure division with correction:
  ETH difference between total pending rewards and DefaultPool: 1000000000
  SAIDebt difference between total pending rewards and DefaultPool: 1000000000
  */
  ...
  it("101 accounts with random ETH and proportional SAI (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    ...
    // Troves open with 100-200 million ether and proportional SAI Debt
    await th.openTrove_allAccounts_randomETH_ProportionalSAI(100000000, 200000000, accounts.slice(0, 101), contracts, 180)
  ...
  /*
    ...
    SAIDebt difference between total pending rewards and DefaultPool: 870000000000

    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 10000000000
    SAIDebt difference between total pending rewards and DefaultPool: 10000000000
  */
})
 ...
 Test to see if error is stable or grows. 
  ...
  1) Reward applications accumulate ETH and SAIDebt error in DefaultPool

  2) Liquidations accumulate ETH and SAIDebt error in DefaultPool
  ...
  5) StabilityPool Withdrawals can accumulate SAILoss in the StabilityPool (i.e. they distribute too much SAI), and can block
