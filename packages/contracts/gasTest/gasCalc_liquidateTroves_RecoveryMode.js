...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 SAI
    ...
    //1 accts open Trove with 1 ether and withdraw 100 SAI
    ...
    // Account 500 opens with 1 ether and withdraws 100 SAI
    ...
    // Check initial troves with starting 10E/90SAI are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 SAI
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 SAI
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion SAI
    ...
    // Check SP has 9e28 SAI
    const SAIinSP = (await stabilityPool.getTotalSAIDeposits()).toString()
    assert.equal(SAIinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 SAI
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90SAI, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check SAI in SP has decreased but is still > 0
    const SAIinSP_After = await stabilityPool.getTotalSAIDeposits()
    assert.isTrue(SAIinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(SAIinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 SAI
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 SAI
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'ether'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 SAI
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraws SAI

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ether and withdraws SAI
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 SAI
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(100, 'ether') })
