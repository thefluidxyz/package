...
contract('Gas cost tests', async accounts => {
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 0 existing Troves in system. Adds 10 ether and issues 100 SAI'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 1 existing Trove in system. Adds 10 ether and issues 100 SAI'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, Inserts between 2 existing CDs in system. Adds 10 ether and issues 80 SAI. '
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues 100 SAI'

  //   const amountETH = dec(10, 'ether')
  //   const amountSAI = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountSAI)
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues less SAI than the previous one'
  //   const amountETH = dec(10, 'ether')
  //   const amountSAI = 200
  //   const gasResults = await th.openTrove_allAccounts_decreasingSAIAmounts(_10_Accounts, contracts, amountETH, amountSAI)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'openTrove(), 50 accounts, each account adds random ether and random SAI'
    const amountETH = dec(10, 'ether')
    const amountSAI = 0
    const gasResults = await th.openTrove_allAccounts_randomETH_randomSAI(1, 9, _50_Accounts, contracts, 2, 100, true)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/SAI Increase/Increase. 10 accounts, each account adjusts up -  1 ether and 100 SAI'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })

  //   const amountETH = dec(10, 'ether')
  //   const amountSAI = dec(100, 18)
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountSAI)


  //   const amountETH_2 = dec(1, 'ether')
  //   const amountSAI_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountSAI_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/SAI Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 ether and 10 SAI'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountSAI_2 = "-10000000000000000000" // debt decrease of 10 SAI 
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountSAI_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/SAI Increase/Decrease. 10 accounts, each account adjusts up by 0.1 ether and down by 10 SAI'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountETH = dec(10, 'ether')
  //   const amountSAI = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountETH, amountSAI)

  //   // Randomly add between 1-9 ETH, and withdraw 1-100 SAI
  ...
  it("", async () => {
    ...
    const amountSAI = dec(100, 18)
    await th.openTrove_allAccounts(_40_Accounts, contracts, amountETH, amountSAI)
    // Randomly add between 1-9 ETH, and withdraw 1-100 SAI
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingSAIAmounts(_10_Accounts, contracts, dec(10, 'ether'), 200)

    for (account of _10_Accounts ) {
      await saiToken.unprotectedMint(account, dec(1000, 18))
    }
  ...
  it("", async () => {
    const message = 'closeTrove(), 20 accounts, each account adds 10 ether and issues less SAI than the previous one. First 10 accounts close their trove. '

    await th.openTrove_allAccounts_decreasingSAIAmounts(_20_Accounts, contracts, dec(10, 'ether'), 200)
  ...
  // it("", async () => {
  //   const message = 'withdrawSAI(), first withdrawal, 10 accounts, each account withdraws 100 SAI'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)

  //   const gasResults = await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'withdrawSAI(), second withdrawal, 10 accounts, each account withdraws 100 SAI'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'withdrawSAI(), first withdrawal, 30 accounts, each account withdraws a random SAI amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)

    const gasResults = await th.withdrawSAI_allAccounts_randomAmount(1, 180, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'withdrawSAI(), second withdrawal, 30 accounts, each account withdraws a random SAI amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_30_Accounts, contracts, dec(100, 18))

    const gasResults = await th.withdrawSAI_allAccounts_randomAmount(1, 70, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repaySAI(), partial repayment, 10 accounts, repay 30 SAI (of 100 SAI)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repaySAI_allAccounts(_10_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repaySAI(), second partial repayment, 10 accounts, repay 30 SAI (of 70 SAI)'
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_30_Accounts, contracts, dec(100, 18))
  //   await th.repaySAI_allAccounts(_30_Accounts, contracts, dec(30, 18))

  //   const gasResults = await th.repaySAI_allAccounts(_30_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'repaySAI(), partial repayment, 30 accounts, repay random amount of SAI (of 100 SAI)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_30_Accounts, contracts, dec(100, 18))

    const gasResults = await th.repaySAI_allAccounts_randomAmount(1, 99, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repaySAI(), first repayment, 10 accounts, repay in full (100 of 100 SAI)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repaySAI_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'repaySAI(), first repayment, 30 accounts, repay in full (50 of 50 SAI)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_30_Accounts, contracts, dec(100, 18))
    await th.repaySAI_allAccounts(_30_Accounts, contracts, dec(50, 18))

    const gasResults = await th.repaySAI_allAccounts(_30_Accounts, contracts, dec(50, 18))
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    ...
    const randSAIAmount = th.randAmountInWei(1, 180)
    await borrowerOperations.withdrawSAI(_100pct, randSAIAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and 100 SAI withdrawn'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and random SAI amount withdrawn'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts_randomAmount(1, 1300, _10_Accounts, contracts)
  ...
  it("", async () => {
    ...
    const randSAIAmount = th.randAmountInWei(1, 180)
    await borrowerOperations.openTrove(_100pct, randSAIAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(10, 'ether') })

    // acct 999 adds coll, withdraws SAI, sits at 111% ICR
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and 100 SAI withdrawn, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(100, 18))
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and random SAI amount withdrawn, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(100, 18))
  ...
  // --- redeemCollateral() ---
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 SAI, redemption hits 1 Trove. One account in system, partial redemption'
    await th.openTrove_allAccounts([accounts[0]], contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts([accounts[0]], contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 SAI, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less SAI
    await borrowerOperations.withdrawSAI(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
    await borrowerOperations.withdrawSAI(_100pct, dec(90, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawSAI(_100pct, dec(80, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })

    /* Account 2 redeems 50 SAI. It is redeemed from account 0's Trove, 
    leaving the Trove active with 30 SAI and ((200 *10 - 50 ) / 200 ) = 9.75 ETH. 
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 101 SAI, redemption hits 2 Troves, last redemption is partial'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 500 SAI, redeems 101 SAI
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawSAI(_100pct, dec(500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 SAI, redemption hits 5 Troves, all full redemptions'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 500 SAI, redeems 500 SAI
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawSAI(_100pct, dec(500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 450 SAI, redemption hits 5 Troves,  last redemption is partial (50 of 100 SAI)'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 450 SAI, redeems 500 SAI
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawSAI(_100pct, dec(450, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 SAI, redemption hits 10 Troves'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 1000 SAI, redeems 500 SAI
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawSAI(_100pct, dec(1000, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 SAI, redemption hits 15 Troves'
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_20_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 1500 SAI, redeems 1500 SAI
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawSAI(_100pct, dec(1500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 SAI, redemption hits 20 Troves'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_30_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 2000 SAI, redeems 2000 SAI
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawSAI(_100pct, dec(2000, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  // it("", async () => { 
  //   const message = 'redeemCollateral(),  SAI, each redemption only hits the first Trove, never closes it'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawSAI_allAccounts(_20_Accounts, troveManager, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 SAI, redemption hits 1 Trove, WITH pending rewards. One account in system'
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(100, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })

    // acct 998 adds coll, withdraws SAI, sits at 111% ICR
    await th.openTrove_allAccounts([accounts[998]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[998], ZERO_ADDRESS, { from: accounts[998] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 SAI, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less SAI
    await borrowerOperations.withdrawSAI(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 SAI, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 SAI, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 SAI, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_20_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 SAI, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  // it("", async () => { 
  //   const message = 'redeemCollateral(),  SAI, each redemption only hits the first Trove, never closes it, WITH pending rewards'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawSAI_allAccounts(_20_Accounts, troveManager, dec(100, 18))

  //    // acct 999 adds coll, withdraws SAI, sits at 111% ICR
  //    await borrowerOperations.addColl(accounts[999], {from: accounts[999], value:dec(1, 'ether')})
  //    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[999], ZERO_ADDRESS, { from: accounts[999]})
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0 )
  //   await th.withdrawSAI_allAccounts_randomAmount(1, 180, _10_Accounts, borrowerOperations)
  ...
  //   await th.withdrawSAI_allAccounts_randomAmount(1, 180, _10_Accounts, troveManager)
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, part of issued SAI: all accounts withdraw 180 SAI, all make first deposit, provide 100 SAI'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, all issued SAI: all accounts withdraw 180 SAI, all make first deposit, 180 SAI'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 SAI, all make first deposit, random SAI amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, deposit part of issued SAI: all accounts withdraw 180 SAI, all make second deposit, provide 50 SAI'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, deposit all issued SAI: all accounts withdraw 180 SAI, make second deposit, provide 90 SAI'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 SAI, make second deposit, random SAI amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(_10_Accounts, contracts, dec(130, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit part of issued SAI: all accounts make second deposit, provide 50 SAI'
  //   // 9 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 50 SAI to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 170 SAI
  ...
  //   // 9 active Troves top up their Stability Pool deposits with 50 SAI
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit all issued SAI: all accounts make second deposit, provide 90 SAI'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 90 SAI to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSAI_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 180 SAI
  //   await borrowerOperations.openTrove(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(1, 'ether') })
  ...
  //   // 5 active Troves top up their Stability Pool deposits with 90 SAI, using up all their issued SAI
  ...
  it("", async () => {
    const message = 'provideToSP(), with pending rewards in system. deposit part of issued SAI: all make second deposit, provide random SAI amount'
    // 10 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 90 SAI to Stability Pool
    ...
    // 5 active Troves top up their Stability Pool deposits with a random SAI amount
  ...
  // partial
  // it("", async () => {
  //   const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - 90 SAI of 180 SAI deposit'
  ...
  // full
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make full withdrawal - 130 SAI of 130 SAI deposit'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(190, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(130, 18))
  ...
  // random amount
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - random SAI amount, less than 180 SAI deposit'
  ...
  // it("", async () => {
  //   const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - 90 SAI of 130 SAI deposit'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 180 SAI to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  ...
  //   await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  //   // 5 active Troves reduce their Stability Pool deposit by 90 SAI
  ...
  it("", async () => {
    const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make full withdrawal - 130 SAI of 130 SAI deposit'
    // 10 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 180 SAI to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
    ...
    // 5 active Troves reduce their Stability Pool deposit by 130 SAI
  ...
  it("", async () => {
    const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - random amount of SAI'
    // 10 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 130 SAI to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 SAI, provide 180 SAI, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 130 SAI to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  it("", async () => {
    const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 SAI, provide a random amount, then withdraw all to SP after a liquidation'
    // 20 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 180 SAI to Stability Pool
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 180 SAI
    await th.openTrove_allAccounts(accounts.slice(100, 110), contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(accounts.slice(100, 110), contracts, dec(130, 18))

    //6s acct open Trove with 1 ether and withdraw 180 SAI (inc gas comp)
  ...
  it("", async () => {
    ...
    // 100 accts each open Trove with 10 ether, withdraw 180 SAI
    await th.openTrove_allAccounts(accounts.slice(100, 200), contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(accounts.slice(100, 200), contracts, dec(130, 18))

    const liquidationAcctRange = accounts.slice(1, 10)

    // Accts open Trove with 1 ether and withdraws 180 SAI (inc gas comp)
    await th.openTrove_allAccounts(liquidationAcctRange, contracts, dec(1, 'ether'), 0)
    await th.withdrawSAI_allAccounts(liquidationAcctRange, contracts, dec(130, 18))
  ...
  it("", async () => {
    ...
    //2 acct open Trove with 1 ether and withdraws 180 SAI (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(2, 4), contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
  ...
  it("", async () => {
    ...
    //3 acct open Trove with 1 ether and withdraws 180 SAI (inc gas comp)
    ...
    // Account 100 provides 600 SAI to pool
    await borrowerOperations.withdrawSAI(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    // 5 acct open Trove with 1 ether and withdraws 180 SAI (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(0, 5), contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[4], ZERO_ADDRESS, { from: accounts[4] })

    // Price drops, account[1]'s ICR falls below MCR
    await priceFeed.setPrice(dec(100, 18))

    // Account 100 provides 360 SAI to SP
    await borrowerOperations.withdrawSAI(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    //4 acct open Trove with 1 ether and withdraws 180 SAI (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(0, 4), contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
    ...
    // account 1 180 SAI liquidated  - partial offset
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] })
    const gas = th.gasUsed(tx)
    th.logGas(gas, message)
  ...
  it("", async () => {
    ...
    // account 1 70 SAI liquidated  - partial offset against 50 SAI in SP
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] })
    const gas = th.gasUsed(tx)
    th.logGas(gas, message)
  ...
  it("", async () => {
    ...
    //Account 99 and 98 each open Trove with 1 ether, and withdraw 180 SAI (inc gas comp)
    await th.openTrove_allAccounts([accounts[99]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[99], ZERO_ADDRESS, { from: accounts[99] })
    await th.openTrove_allAccounts([accounts[98]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[98], ZERO_ADDRESS, { from: accounts[98] })

    // Acct 99 deposits 1 SAI to SP
    await stabilityPool.provideToSP(dec(1, 18), ZERO_ADDRESS, { from: accounts[99] })

    //Account 97 opens Trove with 1 ether and withdraws 180 SAI (inc gas comp)
    await th.openTrove_allAccounts([accounts[97]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawSAI(_100pct, dec(130, 18), accounts[97], ZERO_ADDRESS, { from: accounts[97] })

    // Acct 100 withdraws 1800 SAI and deposits it to the SP
    await borrowerOperations.withdrawSAI(_100pct, dec(1750, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
    ...
    // Account 7 deposits 1 SAI in the Stability Pool
  ...
  it("", async () => {
    ...
    // 30 accts each open Trove with 10 ether, withdraw 180 SAI, and provide 180 SAI to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(100, 130), contracts, dec(10, 'ether'), 0)
    await th.withdrawSAI_allAccounts(accounts.slice(100, 130), contracts, dec(130, 18))

    await stabilityPool.provideToSP(dec(130, 18), ZERO_ADDRESS, { from: accounts[100] })

    //1 acct open Trove with 1 ether and withdraws 180 SAI (inc gas comp)
