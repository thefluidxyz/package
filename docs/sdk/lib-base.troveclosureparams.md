...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [TroveClosureParams](./lib-base.troveclosureparams.md)

## TroveClosureParams type

Parameters of a [closeTrove()](./lib-base.transactablefluid.closetrove.md) transaction.

<b>Signature:</b>

```typescript
export declare type TroveClosureParams<T> = _CollateralWithdrawal<T> & _NoCollateralDeposit & Partial<_SAIRepayment<T>> & _NoSAIBorrowing;
```
