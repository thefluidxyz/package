...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [TroveCreationDetails](./lib-base.trovecreationdetails.md)

## TroveCreationDetails interface

Details of an [openTrove()](./lib-base.transactablefluid.opentrove.md) transaction.
...
|  --- | --- | --- |
|  [fee](./lib-base.trovecreationdetails.fee.md) | [Decimal](./lib-base.decimal.md) | Amount of SAI added to the Trove's debt as borrowing fee. |
