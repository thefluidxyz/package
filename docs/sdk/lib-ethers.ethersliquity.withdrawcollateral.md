...
[Home](./index.md) &gt; [@fluid/lib-ethers](./lib-ethers.md) &gt; [SeisFluid](./lib-ethers.ethersfluid.md) &gt; [withdrawCollateral](./lib-ethers.ethersfluid.withdrawcollateral.md)

## SeisFluid.withdrawCollateral() method
...
```typescript
withdrawCollateral(amount: Decimalish, overrides?: SeisTransactionOverrides): Promise<TroveAdjustmentDetails>;
```
