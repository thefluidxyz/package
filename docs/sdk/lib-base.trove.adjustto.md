...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [Trove](./lib-base.trove.md) &gt; [adjustTo](./lib-base.trove.adjustto.md)

## Trove.adjustTo() method

Calculate the parameters of an [adjustTrove()](./lib-base.transactablefluid.adjusttrove.md) transaction that will change this Trove into the given Trove.
