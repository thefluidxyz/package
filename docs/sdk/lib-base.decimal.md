...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [Decimal](./lib-base.decimal.md)
...
Used by Fluid libraries to precisely represent native currency (e.g. Sei), SAI and FLO amounts, as well as derived metrics like collateral ratios.
