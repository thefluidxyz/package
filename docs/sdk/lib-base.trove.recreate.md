...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [Trove](./lib-base.trove.md) &gt; [recreate](./lib-base.trove.recreate.md)

## Trove.recreate() method

Calculate the parameters of an [openTrove()](./lib-base.transactablefluid.opentrove.md) transaction that will result in the given Trove.
