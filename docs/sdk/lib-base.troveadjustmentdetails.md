...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [TroveAdjustmentDetails](./lib-base.troveadjustmentdetails.md)

## TroveAdjustmentDetails interface

Details of an [adjustTrove()](./lib-base.transactablefluid.adjusttrove.md) transaction.
...
|  --- | --- | --- |
|  [fee](./lib-base.troveadjustmentdetails.fee.md) | [Decimal](./lib-base.decimal.md) | Amount of SAI added to the Trove's debt as borrowing fee. |
