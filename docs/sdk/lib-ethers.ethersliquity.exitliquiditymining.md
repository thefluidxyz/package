...
[Home](./index.md) &gt; [@fluid/lib-ethers](./lib-ethers.md) &gt; [SeisFluid](./lib-ethers.ethersfluid.md) &gt; [exitLiquidityMining](./lib-ethers.ethersfluid.exitliquiditymining.md)

## SeisFluid.exitLiquidityMining() method
...
```typescript
exitLiquidityMining(overrides?: SeisTransactionOverrides): Promise<void>;
```
