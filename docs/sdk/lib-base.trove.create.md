...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [Trove](./lib-base.trove.md) &gt; [create](./lib-base.trove.create.md)

## Trove.create() method

Calculate the result of an [openTrove()](./lib-base.transactablefluid.opentrove.md) transaction.
