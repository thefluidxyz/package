...
[Home](./index.md) &gt; [@fluid/lib-base](./lib-base.md) &gt; [FluidReceipt](./lib-base.fluidreceipt.md)
...
```typescript
export declare type FluidReceipt<R = unknown, D = unknown> = PendingReceipt | MinedReceipt<R, D>;
```
