...
[Home](./index.md) &gt; [@fluid/lib-ethers](./lib-ethers.md) &gt; [ReadableEthersLiquity](./lib-ethers.readableethersliquity.md)

## ReadableEthersLiquity class

Ethers-based implementation of [ReadableFluid](./lib-base.readablefluid.md)<!-- -->.

<b>Signature:</b>

```typescript
export declare class ReadableEthersLiquity implements ReadableFluid 
```
